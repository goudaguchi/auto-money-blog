...
export default function OSDiagnosisPage() {
  ...
  if (phase === 'result' && finalResult) {
    ...
    const parameterDetails: Record<string, {
      ...
      situations: { low: string[]; high: string[] };
      strategies: { low: string[]; high: string[] };
      relatedTo: string;
    }> = {
      impulse: {
        name: '衝動性',
        ...
        detailedExplanation: '衝動性は「抑制機能」と深く関係しています。高い衝動性はADHD特性と関連することがありますが、それ自体が問題なわけではありません。状況に応じて瞬発力を活かせる場面と、ブレーキが必要な場面を見極めることが大切です。',
        situations: {
          low: ['新しいことを始める前に徹底的に調べる', '感情的になっても言葉を選んで話せる', '衝動買いはほとんどしない'],
          high: ['面白そうと思ったらすぐ申し込む', 'SNSで思ったことをすぐ投稿する', 'セールを見ると買ってしまう'],
        },
        strategies: {
          low: ['「72時間ルール」を「24時間ルール」に短縮してみる', '小さなリスクを意図的に取る練習', '完璧主義を手放す'],
          high: ['大きな決定は「一晩寝かせる」', 'SNSは下書き保存→翌日投稿', '衝動買い防止のためカートに入れて24時間待つ'],
        },
        relatedTo: 'ADHD特性（多動・衝動性）と関連。計画性と負の相関',
      },
      planning: {
        name: '計画性',
        icon: '📋',
        ...
        detailedExplanation: '計画性は「実行機能」の一部です。低い計画性はADHD特性と関連することがありますが、柔軟性や即興力という強みにもなります。逆に高すぎる計画性は、変化への適応を難しくすることも。',
        situations: {
          low: ['旅行は行き当たりばったりが好き', '締め切り直前に集中力が出る', '予定が変わっても平気'],
          high: ['旅行は事前にスケジュールを組む', '締め切りより前に終わらせたい', '急な予定変更にストレスを感じる'],
        },
        strategies: {
          low: ['長期の目標は「最低限これだけ」を決める', '外部ツール（カレンダー、リマインダー）に頼る', 'バッファ時間を多めに取る'],
          high: ['計画は「仮説」として捉える', '15%の余白を意図的に作る', '「想定外」を楽しむマインドを持つ'],
        },
        relatedTo: 'ADHD特性（不注意）と関連。ASD特性（ルーティン好き）は高い計画性と関連することも',
      },
      empathy: {
        name: '共感性',
        icon: '💚',
        ...
        detailedExplanation: '共感性にはHSP特性（情緒的感受性）が強く関係します。高い共感性は対人関係の強みになりますが、「情緒的伝染」を起こしやすく、他者の感情に振り回されることも。境界線（バウンダリー）の設定が重要です。',
        situations: {
          low: ['人の話を聞いても自分の意見は変わりにくい', '映画で泣くことは少ない', '批判されても引きずらない'],
          high: ['人の話を聞くと自分のことのように感じる', '映画やドラマでよく泣く', '批判されると深く傷つく'],
        },
        strategies: {
          low: ['相手の立場で考える「if」思考を練習', '感情的な言葉に注目してみる', 'フィードバックを積極的に求める'],
          high: ['「これは私の感情？」と自問する習慣', '感情的な場面の後は一人の時間を確保', 'バウンダリー（境界線）を意識する'],
        },
        relatedTo: 'HSP特性（情緒吸収）と強く関連。エンパス傾向',
      },
      risk: {
        name: 'リスク許容度',
        icon: '🎲',
        ...
        detailedExplanation: 'リスク許容度は、不確実性への耐性と関係しています。HSS（刺激追求）特性が高い人はリスクを取りやすい傾向があります。また、過去の成功・失敗体験も影響します。重要なのは「取るべきリスク」と「避けるべきリスク」を区別すること。',
        situations: {
          low: ['転職は慎重に検討する', '投資は元本保証のものを選ぶ', '新しいことを始めるのに時間がかかる'],
          high: ['チャンスと思ったら飛び込む', '投資でハイリスク・ハイリターンも選ぶ', '失敗してもすぐ次に挑戦する'],
        },
        strategies: {
          low: ['「小さく試す」実験を習慣化', '最悪のケースを具体的に想像してみる（意外と大丈夫）', 'リスクを取った人の体験談を聞く'],
          high: ['「守るべきライン」を明確に決める', '大きな決定は信頼できる人に相談', '撤退基準を事前に決めておく'],
        },
        relatedTo: 'HSS特性（刺激追求）と関連。ADHD特性（衝動性）とも関連することがある',
      },
      boundary: {
        name: '自己境界',
        icon: '🛡️',
        ...
        detailedExplanation: '自己境界は「バウンダリー」とも呼ばれ、心理的健康に直結します。低すぎる境界は燃え尽き症候群のリスク、高すぎる境界は孤立のリスクがあります。HSP特性や共依存傾向のある人は境界が低くなりやすいです。',
        situations: {
          low: ['頼まれると断れない', '相手の機嫌を優先してしまう', '自分の意見を言うのが苦手'],
          high: ['無理な頼みは断れる', '自分の時間を大切にできる', '嫌なことは嫌と言える'],
        },
        strategies: {
          low: ['「考えさせて」と言う練習', '小さな「NO」から始める', '自分のキャパシティを把握する'],
          high: ['時には「YES」と言ってみる', '相手の事情を聞いてみる余裕を持つ', '深い関係を築く人を選ぶ'],
        },
        relatedTo: 'HSP特性（共感性）と負の相関。擬態コストとも関連',
      },
      creation: {
        name: '創作コミット',
        icon: '🎨',
        ...
        detailedExplanation: '創作コミットは「フロー状態」に入りやすいかどうかと関係しています。ADHD特性（過集中）やASD特性（特定分野への深い興味）を持つ人は高くなる傾向があります。創作活動は回復手段にもなりますが、没頭しすぎると生活バランスが崩れるリスクも。',
        situations: {
          low: ['趣味より実用的なことを優先する', '創作活動を始めてもすぐ飽きる', '作品を作るより鑑賞するほうが好き'],
          high: ['創作に没頭すると時間を忘れる', 'アイデアが浮かぶと止められない', '作品を作ることが生きがい'],
        },
        strategies: {
          low: ['週に1回「役に立たない時間」を作る', '創作活動を試してみる（絵、文章、音楽など）', 'インプットを増やす'],
          high: ['開始前に終了時間をセット', '生活の最低ラインを決める（食事、睡眠）', '創作以外の回復手段も持つ'],
        },
        relatedTo: 'ADHD特性（過集中）、ASD特性（特定分野への深い興味）と関連',
      },
      money: {
        name: '金銭感覚',
        icon: '💰',
        ...
        detailedExplanation: '金銭感覚は衝動性と深く関係しています。ADHD特性（衝動性）が高い人は衝動買いをしやすく、将来の報酬より今の報酬を優先する傾向があります。一方で、不安傾向が高い人は過度に堅実になることも。自動化と仕組み化がカギです。',
        situations: {
          low: ['欲しいものはすぐ買う', '貯金が苦手', 'お金の管理が面倒'],
          high: ['購入前に比較検討する', '毎月貯金できている', '家計簿をつけている'],
        },
        strategies: {
          low: ['給料日に先取り貯金を自動化', '大きな買い物は24時間待つルール', 'サブスクを定期的に見直す'],
          high: ['「使っていい枠」を決めて罪悪感なく使う', '経験にお金を使ってみる', '時間をお金で買う発想を持つ'],
        },
        relatedTo: 'ADHD特性（衝動性）と負の相関。リスク許容度とも関連',
      },
    };
        ...
        <div className="max-w-3xl mx-auto px-4 py-12">
          ...
          {sensoryResult && (
            <div className="bg-stone-800/30 rounded-2xl p-6 mb-6 border border-stone-700/50">
              ...
              {/* 神経タイプ別の総合アドバイス */}
              <div className="bg-gradient-to-r from-teal-900/30 to-purple-900/30 rounded-xl p-4 mb-6 border border-white/10">
                <p className="font-medium text-white mb-2">💡 あなたの神経タイプへのアドバイス</p>
                <p className="text-sm text-gray-300 leading-relaxed">
                  {/* AuDHD系 */}
                  {sensoryResult.neurotype.includes('AuDHD') && (
                    <>ASD特性とADHD特性の両方を持つあなたは、「一貫性を求める自分」と「刺激を求める自分」の間で葛藤することがあるかもしれません。どちらも本当のあなたです。環境を整え（ASD向け）つつ、適度な新規性も取り入れる（ADHD向け）バランスを見つけましょう。過集中と注意散漫の波を理解し、「今日はどっちモードか」を意識すると楽になります。</>
                  )}
                  {/* HSP + ADHD系 */}
                  {sensoryResult.neurotype.includes('HSP') && sensoryResult.neurotype.includes('ADHD') && !sensoryResult.neurotype.includes('AuDHD') && (
                    <>繊細さと衝動性という一見矛盾する特性を持つあなた。刺激に敏感なのに、同時に刺激を求めてしまう。この「アクセルとブレーキを同時に踏んでいる感覚」は、あなただけではありません。小さな刺激をこまめに取り入れつつ、回復時間を必ず確保するリズムを作りましょう。</>
                  )}
                  {/* HSP + ASD */}
                  {sensoryResult.neurotype.includes('HSP') && sensoryResult.neurotype.includes('ASD') && !sensoryResult.neurotype.includes('ADHD') && (
                    <>高い感受性と社会的認知の独自性を持つあなた。他者の感情は深く感じ取れるのに、「普通」の振る舞いがわかりにくいという経験があるかもしれません。自分なりの「社会的ガイドライン」を作り、感覚的に安全な環境を確保することで、あなたの深い洞察力が活きてきます。</>
                  )}
                  {/* ADHD - 不注意優勢型 */}
                  {sensoryResult.neurotype.includes('不注意優勢') && (
                    <>「静かなADHD」とも呼ばれるタイプ。多動や衝動性は目立たないけれど、頭の中は常にフル回転。ぼーっとしているように見えても、実は深く考えていることが多いです。外部ツール（リマインダー、タイマー、チェックリスト）を「脳の拡張機能」として活用し、頭の中のカオスを外に出力する習慣を作りましょう。</>
                  )}
                  {/* ADHD - 多動・衝動優勢型 */}
                  {sensoryResult.neurotype.includes('多動') && !sensoryResult.neurotype.includes('混合') && (
                    <>エネルギッシュで行動力があるあなた。「思い立ったらすぐ行動」は大きな強みですが、「3秒ルール」を取り入れてみて。重要な決定の前に3秒だけ深呼吸。体を動かすことでエネルギーを発散させ、その後に集中タスクに取り組むと効果的です。</>
                  )}
                  {/* ADHD - 混合型 */}
                  {sensoryResult.neurotype === 'ADHD - 混合型（不注意 + 多動・衝動）' && (
                    <>不注意と多動・衝動性の両方を持つあなた。頭の中も体もじっとしていられない感覚があるかもしれません。「過集中」と「全く集中できない」の波が激しいのが特徴。波を否定せず、「今は集中モードだ」「今は散漫モードだ」と認識し、モードに合った活動を選ぶと楽になります。</>
                  )}
                  {/* ASD（単体） */}
                  {sensoryResult.neurotype.includes('ASD') && !sensoryResult.neurotype.includes('AuDHD') && !sensoryResult.neurotype.includes('HSP') && (
                    <>独自の視点と深い専門性を持つ可能性があるあなた。「普通」のコミュニケーションに疲れることがあっても、それはあなたの価値を下げるものではありません。自分のルーティンと興味を大切にしつつ、信頼できる人に「これってどう思う？」と確認できる関係を作ると安心です。</>
                  )}
                  {/* アスペルガー傾向 */}
                  {sensoryResult.neurotype.includes('アスペルガー') && (
                    <>論理的思考と特定分野への深い関心が強みのあなた。言外の意味や空気を読むことに苦労することがあっても、それは「能力がない」のではなく「脳の使い方が違う」だけ。明確なコミュニケーションを心がけ、曖昧な指示は遠慮なく確認しましょう。</>
                  )}
                  {/* HSS型HSP */}
                  {sensoryResult.neurotype === 'HSS型HSP（刺激追求型・高感受性）' && (
                    <>「繊細なのに刺激を求める」という矛盾を抱えるあなた。新しい体験が好きだけど、すぐ疲れてしまう。これは欠点ではなく、両方を活かせる環境を見つける鍵です。「短時間の冒険→しっかり回復」のサイクルを意識的に作りましょう。</>
                  )}
                  {/* HSE（外向型HSP） */}
                  {sensoryResult.neurotype.includes('HSE') && (
                    <>人との交流を楽しめるけど、深いところで疲れやすいあなた。「楽しかったはずなのに、帰宅後どっと疲れる」経験はありませんか？社交の後には必ず一人の回復時間を確保。あなたの社交性は本物ですが、回復も同じくらい大切です。</>
                  )}
                  {/* HSP - 内向型 */}
                  {sensoryResult.neurotype.includes('HSP - 内向型') && (
                    <>深い内省と繊細な感受性を持つあなた。一人の時間が必要なのは「社交性がない」からではなく、「深く処理している」から。無理に外向的になろうとせず、少人数での深い交流を大切にしましょう。あなたの洞察力は、静かな環境で最も輝きます。</>
                  )}
                  {/* HSP（基本形） */}
                  {sensoryResult.neurotype === 'HSP（Highly Sensitive Person）' && (
                    <>生まれつき感受性が高いあなた。これは全人口の15-20%に見られる気質で、「治す」ものではありません。刺激をコントロールできる環境を整え、自分のペースを守ることで、深い共感力と洞察力という強みを最大限発揮できます。</>
                  )}
                  {/* エンパス */}
                  {sensoryResult.neurotype.includes('エンパス') && (
                    <>他者の感情を自分のことのように感じ取れるあなた。素晴らしい共感力ですが、「これは自分の感情？相手の感情？」を区別する練習が大切。人混みや感情的な場面の後は、意識的に「自分に戻る」時間を取りましょう。</>
                  )}
                  {/* 刺激追求型 */}
                  {sensoryResult.neurotype.includes('刺激追求型（High Sensation Seeker）') && (
                    <>新しい体験やスリルを求めるあなた。退屈は最大の敵。ただし、リスクの取りすぎには注意。「計算されたリスク」を取る習慣を身につけ、冒険心を建設的な方向に活かしましょう。</>
                  )}
                  {/* 感覚処理感受性 */}
                  {sensoryResult.neurotype.includes('感覚処理感受性') && (
                    <>五感が人一倍敏感なあなた。これは脳の特性であり、慣れや訓練で変わるものではありません。「感覚にやさしい環境」を意識的に作ることで、日常の疲労を大幅に減らせます。</>
                  )}
                  {/* ニューロティピカル */}
                  {sensoryResult.neurotype.includes('ニューロティピカル') && (
                    <>特定の神経発達特性は顕著ではありませんが、誰でも得意・不得意はあります。今回の診断で見えた軽度の傾向を参考に、自分の特性を理解し活かしていきましょう。「普通」は存在しません。あなたなりのスタイルを大切に。</>
                  )}
                </p>
              </div>
          ...
          <div className="bg-stone-800/30 rounded-2xl p-6 mb-6 border border-stone-700/50">
            ...
            <div className="space-y-4">
              {(Object.keys(scores) as (keyof DiagnosisScores)[]).map((key) => {
                ...
                const isLow = value <= -2;
                const isExpanded = expandedParams.includes(key);
